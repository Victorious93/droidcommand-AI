...
class WorkspaceManagerTest {
    ...
    @BeforeTest
    fun setUp() {
        root = Files.createTempDirectory("droidcommand-workspace-manager-test")
    }
    ...
    fun `create rejects a root that was not authorized`() {
        val unauthorized = Files.createTempDirectory("droidcommand-workspace-manager-unauthorized")
        try {
            val manager = WorkspaceManager(listOf(root))
    ...
    fun `importSource copies real file content from source into the workspace`() {
        val sourceDir = Files.createTempDirectory("droidcommand-workspace-manager-source")
        try {
