...
import ai.droidcommand.build.BuildResult
...
class LocalProcessBuildExecutorPipelineIntegrationTest {
    ...
    private object NoRequirementsDetector : BuildEnvironmentDetector {
        override fun check(tool: ai.droidcommand.build.EnvironmentTool): ToolCheckResult =
            ToolCheckResult(tool, ai.droidcommand.build.ToolAvailability.AVAILABLE, null)
    }
