...
private fun newSession(): Triple<DroidForgeSession, ToolRegistry, AgentStateMachine> {
    ...
    return Triple(DroidForgeSession(registry, executor, stateMachine), registry, stateMachine)
}

class DroidForgeSessionTest {
    @Test
